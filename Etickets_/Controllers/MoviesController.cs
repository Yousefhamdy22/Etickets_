...
namespace Etickets_.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(IMovie service)
        {
            _service = service;
        }
        ...
        //{
        //    var allMovies = await _service.GetallAsyc(n => n);
        ...
        {
            var allMovies = await _service.GetallAsyc(n => n.Cinema);
      ...
      //  GET: Movies/Details/1
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var response = new NewMovieVM()
            {
                ...
                MovieCategory = movieDetails.Movecategory,
